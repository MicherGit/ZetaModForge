...
public class KeystoneGemOreBlock extends ZetamodModElements.ModElement {
	@ObjectHolder("zetamod:keystone_gem_ore")
	public static final Block block = null;
	public KeystoneGemOreBlock(ZetamodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("keystone_gem_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(KeystoneGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("keystone_gem_ore", "keystone_gem_ore", blockAt -> {
