...
public class KeystoneItem extends ZetamodModElements.ModElement {
	@ObjectHolder("zetamod:keystone")
	public static final Item block = null;
	public KeystoneItem(ZetamodModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used to enter the Etherial Haven"));
		}
	}
}
