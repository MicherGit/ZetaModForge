...
public class StonePickaxeItem extends ZetamodModElements.ModElement {
	@ObjectHolder("zetamod:stone_pickaxe")
	public static final Item block = null;
	public StonePickaxeItem(ZetamodModElements instance) {
		super(instance, 28);
	}
